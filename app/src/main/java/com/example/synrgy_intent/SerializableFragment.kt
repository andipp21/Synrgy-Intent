...
class SerializableFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnSubmitSerializable.setOnClickListener {
            val intent = Intent(activity, ShowSerializable::class.java)

            val nama = etNamaSerializable.text.toString()
            val umur = etUmurSerializable.text.toString()

            // membuat object person
            val obj = PersonSerialization(nama, umur.toInt())

            intent.putExtra("objPerson", obj)
